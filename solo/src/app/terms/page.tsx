...
export const metadata: Metadata = {
  title: "Terms & Conditions | Trade Guard Solo",
  description:
    "Platform terms, preferred withdrawal schedule, and early-exit penalties for Trade Guard Solo.",
};
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:py-16">
      ...
      <p className="mt-3 text-sm text-gray-400">
        ...
        requesting a withdrawal on Trade Guard Solo, you agree
        to these Terms.
      </p>
